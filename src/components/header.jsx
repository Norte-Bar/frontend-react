  ...
  return (
    <>
      ...
      <header className="bg-gray-300 p-4 flex justify-between items-center"> 
        <Link to="/" className="text-2xl font-semibold text-blue-950">
        NORTE BAR
        </Link>

        <nav className="flex gap-2">
            <Link to="/sobre" className="border border-blue-950 text-blue-950 px-4 py-1 rounded-sm text-sm hover:bg-blue-950 hover:text-white transition">
            SOBRE 
          </Link>
